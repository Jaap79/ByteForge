...
.redraw_ready:
    ...
    je .below
.no_hex:
    invoke MoveWindow,[hwndEdit],0,0,[clientW],[clientH],[layoutRedraw]
    jmp .status
.left:
    call ClampHexSplitW
    mov eax,[hexSplitW]
    ...
    mov eax,[clientW]
    sub eax,[tmpPtr]
    invoke MoveWindow,[hwndEdit],[tmpPtr],0,eax,[clientH],[layoutRedraw]
    jmp .status
.right:
    call ClampHexSplitW
    mov eax,[clientW]
    ...
    sub eax,3
    mov [tmpSize],eax
    invoke MoveWindow,[hwndEdit],0,0,[tmpSize],[clientH],[layoutRedraw]
    mov eax,[clientW]
    sub eax,[hexSplitW]
    add eax,3
    mov [tmpPtr],eax
...
.below:
    ...
    sub eax,[hexSplitH]
    sub eax,3
    invoke MoveWindow,[hwndEdit],0,0,[clientW],eax,[layoutRedraw]
    mov eax,[clientH]
    sub eax,[hexSplitH]
    add eax,3
    mov [tmpPtr],eax
